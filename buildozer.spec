...
package.domain = org.davidliebman.android
...
#source.exclude_exts = GetTextActivity.java

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = mldata
#tests, bin
...
requirements = kivy==master,pil,numpy,pyjnius,awesomecnn,sqlite3
#,pil,sqlite3
#,pil,libgpuarray
...
presplash.filename = %(source.dir)s/data/guy_icon.png

# (str) Icon of the application
icon.filename = %(source.dir)s/data/guy_icon.png
